...
def overrideEnvironmentVars(vars_scope):
    ...
    vars_scope["splunk"]["idxc"]["register_forwarder_address"] = os.environ.get('SPLUNK_IDXC_FORWARDER_ADDRESS', vars_scope["splunk"]["idxc"]["register_forwarder_address"])
    vars_scope["splunk"]["idxc"]["register_replication_address"] = os.environ.get('SPLUNK_IDXC_REPLICATION_ADDRESS', vars_scope["splunk"]["idxc"]["register_replication_address"])
    vars_scope["splunk"]["idxc"]["register_search_address"] = os.environ.get('SPLUNK_IDXC_SEARCH_ADDRESS', vars_scope["splunk"]["idxc"]["register_search_address"])    
