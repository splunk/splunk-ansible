...
def getDistributedTopology(vars_scope):
    ...
    vars_scope["splunk"]["license_master_included"] = bool(vars_scope["splunk"]["license_master_url"])
    ...
    vars_scope["splunk"]["indexer_cluster"] = bool(vars_scope["splunk"].get("cluster_master_url"))
